...
const Hero = () => {
    ...
    return (
        <Section
            className='pt-[12rem] -nt-[5.25rem]'
            crosses
            crossesOffset='lg:translate-y-[5.25rem]'
            customPaddings
            id='hero'>
            <div className='container relative' ref={parallaxRef}>
                <div className='relative z-1 max-w-[62rem] mx-auto py-20 text-center
                mb-[4rem] md:mb-20 lg:mb:[6rem]'>
                    ...
                    <p className='body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8'>
                        Unleash the power of AI within Bainwave.
                            ...
                            <div className='aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]'>
                                ...
                                <ScrollParallax isAbsolutelyPositioned>
                                    <ul className='hidden absolute -left-[5.5rem]
                                        bottom-[7.5rem] px-1 py-1 bg-n-9/40 border
